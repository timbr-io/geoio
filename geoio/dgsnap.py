...
class WrappedGeoJSON(dict):
    ...
    def _to_geotiff(self, path=None, node="TOAReflectance", level="0"):
    ...
    def to_DGImage(self, derived_dir=None, **kwargs):
        _path = self._to_geotiff(**kwargs)
        return geoio.DGImage(_path, derived_dir=derived_dir)
